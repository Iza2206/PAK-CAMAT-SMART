    ...
    <main class="flex-1 p-6">
        <div class="max-w-2xl mx-auto bg-white dark:bg-gray-800 rounded-2xl shadow-md p-6">
            <h1 class="text-2xl font-bold mb-6 text-blue-700 dark:text-blue-400">
                ➕ Tambah Pengajuan SKTM Dispensasi Cerai
            </h1>
            ...
            {{-- Form --}}
            <form action="{{ route('SKTMs.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
                @csrf
                ...
                @php
                    $documents = [
                        'sktm_desa' => 'Surat Keterangan Tidak Mampu dari Desa',
                        'kk' => 'Fotokopi Kartu Keluarga (KK)',
                        'ktp' => 'Fotokopi KTP',
                        'buku_nikah' => 'Fotokopi Buku Nikah',
