...
<head>
    <meta charset="UTF-8">
    <title>Laporan Penilaian CATIN Sipil, TNI/POLRI</title>
    <style>
...
<body>
    <h3 style="text-align: center; margin-bottom: 15px;">Laporan Penilaian CATIN Sipil, TNI/POLRI</h3>
