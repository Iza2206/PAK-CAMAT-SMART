    ...
    <main class="flex-1 p-6">
        <div class="max-w-3xl mx-auto bg-white dark:bg-gray-800 rounded-2xl shadow-md p-6">
            <h1 class="text-2xl font-bold mb-6 text-blue-700 dark:text-blue-400">
                📄 Tambah Pengajuan SKT (Surat Keterangan Tanah)
            </h1>
            ...
            <form action="{{ route('skt.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                ...
                @foreach([
                    'file_permohonan' => 'Surat Permohonan SKT Bermaterai',
                    'file_alas_hak' => 'Surat Keterangan Tanah / Alas Hak',
