...
<div class="flex min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-100">
    ...
    <div class="p-6 w-full max-w-4xl mx-auto space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border border-gray-200 dark:border-gray-700">
            ...
            @if ($item->camat->ttd)
                <a href="{{ asset('storage/ttd/' . $item->camat->ttd) }}" 
                download 
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border border-gray-200 dark:border-gray-700">
            ...
            <form method="POST" action="{{ route('mejalayanan.ttdcamat.dispencatin.proses.store', $item->id) }}" enctype="multipart/form-data" class="space-y-4">
                @csrf
                <div>
