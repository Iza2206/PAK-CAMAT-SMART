    ...
    <main class="flex-1 p-6">
        <div class="max-w-3xl mx-auto bg-white dark:bg-gray-800 rounded-2xl shadow-md p-6">
            <h1 class="text-2xl font-bold mb-6 text-blue-700 dark:text-blue-400">
                ➕ Tambah Pengajuan Surat Silang Sengketa
            </h1>
            ...
            <form action="{{ route('sengketa.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                ...
                @foreach([
                    'surat_silang_sengketa' => 'Surat Silang Sengketa dari Kepala Desa',
                    'foto_copy_surat_tanah' => 'Fotokopi Surat Tanah',
                    'bukti_lunas_pbb' => 'Bukti Lunas PBB',
                ] as $field => $label)
                    <div>
