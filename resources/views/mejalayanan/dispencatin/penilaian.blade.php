...
>
    ...
    <main class="flex-1 p-6">
        <h1 class="text-2xl font-bold mb-6 text-blue-700 dark:text-blue-300">📝 Daftar Penilaian Layanan Dispensasi Nikah</h1>

        {{-- Filter --}}
        <form method="GET" action="{{ route('dispencatin.penilaian.index') }}" class="mb-4 flex flex-wrap gap-3 items-center">
    ...
    >
        <div @click.outside="modalOpen = false" class="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-sm shadow-lg">
            ...
            <form method="POST" :action="`/meja-layanan/dispencatin/${selectedId}/penilaian`">
                @csrf
                {{-- Pilihan Penilaian --}}
