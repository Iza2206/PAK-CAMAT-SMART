...
<head>
    <meta charset="UTF-8">
    <title>Laporan Penilaian Surat Keterangan Bersih Diri (SKBD)</title>
    <style>
...
<body>
    <h3 style="text-align: center; margin-bottom: 15px;">Laporan Penilaian Surat Keterangan Bersih Diri (SKBD)</h3>
        ...
        <tbody>
            @foreach ($data as $i => $item)
                ...
                <tr>
                    ...
                    <td>Surat Keterangan Bersih Diri (SKBD)</td>
