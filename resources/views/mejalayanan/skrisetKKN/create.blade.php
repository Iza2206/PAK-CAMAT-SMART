    ...
    <main class="flex-1 p-6">
        <div class="max-w-3xl mx-auto bg-white dark:bg-gray-800 rounded-2xl shadow-md p-6">
            <h1 class="text-2xl font-bold mb-6 text-blue-700 dark:text-blue-400">
                📄 Tambah Pengajuan Surat Keterangan Riset KKN / PKL
            </h1>
            ...
            <form action="{{ route('skrisetKKN.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                ...
                <div>
                    <label class="block mb-1 font-semibold">
                        Surat Keterangan dari Sekolah / Universitas (PDF)
                    </label>
                    <input 
                        type="file" 
                        name="file_surat_sekolah" 
                ...
                <div>
                    <label class="block mb-1 font-semibold">
                        Surat Izin Pengambilan Data dari Dinas Terkait (PDF)
                    </label>
                    <input 
                        type="file" 
                        name="file_izin_pengambilan" 
                        accept="application/pdf" 
                        required
                        class="w-full file:px-4 file:py-2 file:rounded-lg file:border-0 file:bg-blue-600 file:text-white hover:file:bg-blue-700 bg-white dark:bg-gray-700 text-sm rounded-lg"
                    >
