    ...
    >
        ...
        >
            ...
            <div x-show="openBpjs" x-collapse class="ml-6 space-y-1 text-sm text-gray-600 dark:text-gray-400">
                <a href="{{ route('sekcam.bpjs.index') }}"
                    class="block px-3 py-1 rounded transition-all 
                    {{ request()->routeIs('sekcam.bpjs.index') ? 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300 font-semibold' : 'hover:bg-blue-100 hover:text-blue-700 dark:hover:bg-blue-900/20 dark:hover:text-blue-300' }}">
                    📝 Verifikasi BPJS
                </a>
                <a href="{{ route('sekcam.bpjs.proses') }}" 
                    class="block px-3 py-1 rounded transition-all 
                    {{ request()->routeIs('sekcam.bpjs.proses') ? 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300 font-semibold' : 'hover:bg-blue-100 hover:text-blue-700 dark:hover:bg-blue-900/20 dark:hover:text-blue-300' }}">
           ...
           <button @click="openSktm = !openSktm"
            ...
            <div x-show="openSktm"  x-collapse class="ml-6 space-y-1 text-sm text-gray-600 dark:text-gray-400">
                <a href="{{ route('sekcam.sktm.index') }}"
                    class="block px-3 py-1 rounded transition-all 
                    {{ request()->routeIs('sekcam.sktm.index') ? 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300 font-semibold' : 'hover:bg-blue-100 hover:text-blue-700 dark:hover:bg-blue-900/20 dark:hover:text-blue-300' }}">
                    📝 Verifikasi SKTM
                </a>
                <a href="{{ route('sekcam.sktm.proses') }}" 
                    class="block px-3 py-1 rounded transition-all 
                    {{ request()->routeIs('sekcam.sktm.proses') ? 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300 font-semibold' : 'hover:bg-blue-100 hover:text-blue-700 dark:hover:bg-blue-900/20 dark:hover:text-blue-300' }}">
                    <svg class="w-5 h-5 inline-block mr-1" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M3 7l4 0 2-2h6l2 2h4M4 17h6m-6-4h10m-6 8h6M4 21h16a2 2 0 002-2V7a2 2 0 00-2-2H4a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
            ...
            <div x-show="openSkbd" x-collapse class="ml-6 space-y-1 text-sm text-gray-600 dark:text-gray-400">
                <a href="{{ route('sekcam.skbd.index') }}"
                    class="block px-3 py-1 rounded transition-all 
                    {{ request()->routeIs('sekcam.skbd.index') ? 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300 font-semibold' : 'hover:bg-blue-100 hover:text-blue-700 dark:hover:bg-blue-900/20 dark:hover:text-blue-300' }}">
                    📝 Verifikasi SKBD
                </a>
                <a href="{{ route('sekcam.skbd.proses') }}"
                    class="block px-3 py-1 rounded transition-all 
                    {{ request()->routeIs('sekcam.skbd.proses') ? 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300 font-semibold' : 'hover:bg-blue-100 hover:text-blue-700 dark:hover:bg-blue-900/20 dark:hover:text-blue-300' }}">
                    📁 Riwayat Proses SKBD
                </a>
            </div>
